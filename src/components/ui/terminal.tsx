...
export const Terminal = ({
  ...
  const content = (
    ...
    >
      <div className="border-border relative flex h-11 items-center justify-center border-b bg-white/2 px-4">
        <div className="absolute left-4 flex flex-row gap-1.5">
